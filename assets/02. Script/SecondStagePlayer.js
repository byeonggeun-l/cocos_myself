...
cc.Class({
    ...
    doJumpAction: function () {
        ...
        const callbackendJump = cc.callFunc(this.endJump, this);
        // sequence 여러 개의 액션을 하나의 액션으로 묶는다.
        // 시퀀스를 무한히 반복한다.
        const rep = cc.repeat(cc.sequence(jumpUp, jumpDown, callback, callbackendJump), 1);
